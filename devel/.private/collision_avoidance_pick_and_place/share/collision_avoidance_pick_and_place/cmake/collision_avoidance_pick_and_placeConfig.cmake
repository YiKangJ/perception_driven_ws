...
if("TRUE" STREQUAL "TRUE")
  set(collision_avoidance_pick_and_place_SOURCE_PREFIX /home/jyk/perception_driven_ws/src/collision_avoidance_pick_and_place)
  set(collision_avoidance_pick_and_place_DEVEL_PREFIX /home/jyk/perception_driven_ws/devel/.private/collision_avoidance_pick_and_place)
  ...
  set(collision_avoidance_pick_and_place_INSTALL_PREFIX /home/jyk/perception_driven_ws/install)
...
if(NOT "/home/jyk/perception_driven_ws/devel/.private/collision_avoidance_pick_and_place/include " STREQUAL " ")
  set(collision_avoidance_pick_and_place_INCLUDE_DIRS "")
  set(_include_dirs "/home/jyk/perception_driven_ws/devel/.private/collision_avoidance_pick_and_place/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/collision_avoidance_pick_and_place " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/collision_avoidance_pick_and_place' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'collision_avoidance_pick_and_place' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'collision_avoidance_pick_and_place' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jyk/perception_driven_ws/src/collision_avoidance_pick_and_place/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jyk/perception_driven_ws/devel/.private/collision_avoidance_pick_and_place/lib;/home/jyk/perception_driven_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(collision_avoidance_pick_and_place_EXPORTED_TARGETS "collision_avoidance_pick_and_place_generate_messages_cpp;collision_avoidance_pick_and_place_generate_messages_eus;collision_avoidance_pick_and_place_generate_messages_lisp;collision_avoidance_pick_and_place_generate_messages_nodejs;collision_avoidance_pick_and_place_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${collision_avoidance_pick_and_place_dep}_FOUND)
      find_package(${collision_avoidance_pick_and_place_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${collision_avoidance_pick_and_place_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
