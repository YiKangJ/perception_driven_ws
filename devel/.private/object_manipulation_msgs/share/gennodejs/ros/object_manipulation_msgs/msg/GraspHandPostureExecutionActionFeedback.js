...
class GraspHandPostureExecutionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GraspHandPostureExecutionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GraspHandPostureExecutionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GraspHandPostureExecutionActionFeedback(null);
    ...
    data.feedback = GraspHandPostureExecutionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GraspHandPostureExecutionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GraspHandPostureExecutionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GraspHandPostureExecutionFeedback()
    }
...
module.exports = GraspHandPostureExecutionActionFeedback;
