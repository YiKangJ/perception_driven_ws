...
"""autogenerated by genpy from object_manipulation_msgs/GraspHandPostureExecutionResult.msg. Do not edit."""
import sys
...
class GraspHandPostureExecutionResult(genpy.Message):
  _md5sum = "f81d941ac01806ebaf0578f78def0828"
  _type = "object_manipulation_msgs/GraspHandPostureExecutionResult"
...
"""
  __slots__ = ['result']
  _slot_types = ['object_manipulation_msgs/ManipulationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspHandPostureExecutionResult, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.result is None:
        self.result = object_manipulation_msgs.msg.ManipulationResult()
    else:
      self.result = object_manipulation_msgs.msg.ManipulationResult()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_i().pack(self.result.value))
